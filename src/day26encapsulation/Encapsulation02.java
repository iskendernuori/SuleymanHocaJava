...
public class Encapsulation02 {
	...
	// variable atanan degerin depistrilmesini istemiyorsanız o variable ile
	// alakali setter() olusturmamalısınız.
	
	// variable a atanan degerin okunmasini istemiyorsanız , o variable ile alakalı 
	// getter() olusturmamalisınız.
	
	
	// sadece getter() kullanır ve hic setter()  kullanmazsanız variable degerleri 
