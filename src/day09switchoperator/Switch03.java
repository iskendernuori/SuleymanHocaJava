...
public class Switch03 {
	...
	public static void main(String[] args) {
		...
		month= month.toLowerCase();// Stringleri kucuk harfe çevirmeye yarar
		// toUpperCase() string leri buyuk harfe çevirmek için kullanılır
		...
		case "aralik" : 
			...
			break;
		default:
			System.out.println("Gecerli Bir ay ismi gir");
