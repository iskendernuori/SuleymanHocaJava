...
public class Constructor03 {
	...
	Constructor03(){
//		this.isim=isim;    kullanılmadiğı için silinebilir
//		this.yas= yas;
//		this.kilo=kilo;
//		this.meslek=meslek;
//		this.emekli=emekli;
	...
	public static void main(String[] args) {
		...
		Constructor03 insan02 = new Constructor03("Ayhan Yildiz", 56, true);// burada ismi ve yasi degiştirdik, emekli olmasi durumunu.
